...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
	...
	return (
		<div className="w-full" ref={containerRef}>
			<div ref={ref} className="relative max-w-7xl mx-auto space-y-10">
				{data.map((item, index) => (
				...
				>
					<motion.div
						...
						className="absolute inset-x-0 top-0 w-0.5 bg-linear-to-t from-secondary via-accent to-transparent from-0% via-10% rounded-full"
					/>
				</div>
			</div>
		</div>
